...
import type { ArtistProfile as _ArtistProfile, ExternalBlob as _ExternalBlob, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createArtistProfile(arg0: string, arg1: string, arg2: string, arg3: string, arg4: ExternalBlob | null, arg5: string | null, arg6: string | null, arg7: string | null, arg8: string | null, arg9: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createArtistProfile(arg0, arg1, arg2, arg3, await to_candid_opt_n8(this._uploadFile, this._downloadFile, arg4), to_candid_opt_n10(this._uploadFile, this._downloadFile, arg5), to_candid_opt_n10(this._uploadFile, this._downloadFile, arg6), to_candid_opt_n10(this._uploadFile, this._downloadFile, arg7), to_candid_opt_n10(this._uploadFile, this._downloadFile, arg8), to_candid_opt_n10(this._uploadFile, this._downloadFile, arg9));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterArtistsByGenre(arg0: string): Promise<Array<ArtistProfile>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterArtistsByGenre(arg0);
    ...
    async getArtistProfileById(arg0: string): Promise<ArtistProfile> {
        if (this.processError) {
            try {
                const result = await this.actor.getArtistProfileById(arg0);
    ...
    async searchArtistByName(arg0: string): Promise<Array<ArtistProfile>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchArtistByName(arg0);
                return from_candid_vec_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ArtistProfile_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ArtistProfile): Promise<ArtistProfile> {
...
async function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        instagramLink: record_opt_to_undefined(from_candid_opt_n14(_uploadFile, _downloadFile, value.instagramLink)),
        spotifyLink: record_opt_to_undefined(from_candid_opt_n14(_uploadFile, _downloadFile, value.spotifyLink)),
        youtubeLink: record_opt_to_undefined(from_candid_opt_n14(_uploadFile, _downloadFile, value.youtubeLink)),
        twitterLink: record_opt_to_undefined(from_candid_opt_n14(_uploadFile, _downloadFile, value.twitterLink)),
        name: value.name,
        createdAt: value.createdAt,
        biography: value.biography,
        soundcloudLink: record_opt_to_undefined(from_candid_opt_n14(_uploadFile, _downloadFile, value.soundcloudLink)),
        genre: value.genre,
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ArtistProfile>): Promise<Array<ArtistProfile>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ArtistProfile_n12(_uploadFile, _downloadFile, x)));
}
