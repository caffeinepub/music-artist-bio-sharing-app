...
export interface _SERVICE {
  ...
  'createArtistProfile' : ActorMethod<
    ...
    undefined
  >,
  'filterArtistsByGenre' : ActorMethod<[string], Array<ArtistProfile>>,
  'getAllArtistProfiles' : ActorMethod<[], Array<ArtistProfile>>,
  'getAllGenres' : ActorMethod<[], Array<string>>,
  'getArtistProfileById' : ActorMethod<[string], ArtistProfile>,
  'searchArtistByName' : ActorMethod<[string], Array<ArtistProfile>>,
}
